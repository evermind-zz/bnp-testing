...
public final class BraveRumbleCloudflareManagerOriginal {
    ...
    private static volatile BraveRumbleCloudflareManagerOriginal instance;
    ...
    private BraveRumbleCloudflareManagerOriginal(final Context context) {
    ...
    public static BraveRumbleCloudflareManagerOriginal getInstance(final Context context) {
        if (instance == null) {
            synchronized (BraveRumbleCloudflareManagerOriginal.class) {
                if (instance == null) {
                    instance = new BraveRumbleCloudflareManagerOriginal(context);
                }
            }
        }
        return instance;
